...
In this acticle, we will create a new package `note` of company `company`. The _Notes_ app will support following features:
...
Admin can manuapulate menus in AdminCP, such as: adding new menu item **+ Add Note** with URL `/note/add` to the menu `note.sidebarMenu`
...
_MetaFox_ Localization follows [laravel-localization](https://laravel.com/docs/5.0/localization#introduction)

### Add Phrases

The simplest way to add translation phrases is via AdminCP, visit **AdminCP** > **Globalization** > **Phrases** > **+ Add New Phrase**
