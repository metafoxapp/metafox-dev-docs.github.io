...
In this article, we will guide you to develop a new *Notes* app that allows users to share notes. End users can post new notes, edit their notes, share their notes to Activity Feed, etc.

**Table Of Contents**

- Create a landing page of *Notes* app
...
Firstly, we are going to create a app skeleton. Let's open Terminal and move to the root of your workbox where the *Frontend* source code is located, then execute the following command
