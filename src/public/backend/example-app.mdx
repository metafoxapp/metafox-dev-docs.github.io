...
> In this part, you will learn how to create new note package,
> package vendor is `company` then full package name should be `company/note`

## Generate Files Skeleton

The simple way to init a module is using admincp.
visit admincp at "/admin/app" then follow the winzard to create your first module
...
To generate example code to a resource, access /admin/apps.
