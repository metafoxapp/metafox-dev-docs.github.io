...
**MetaFox** platform is shipped with [DbTableHelper](/php-api/classes/MetaFox-Platform-Support-DbTableHelper.html), to support creating platform schema easily and quickly.
