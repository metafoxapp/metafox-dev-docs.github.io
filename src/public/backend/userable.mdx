...
A special ability of a Contract User is: it used BigNumberId to setEntityId to entities table (global and unique id for all resources).
...
And to define which should be stored in entities table, we has toUserResource(). Example in User, you can define:
