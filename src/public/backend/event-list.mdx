...
# Event Details
Now, we are going to dive into deeper about all supported events

## Model Events

These are events that were called in EloquentModelObserver: packages/platform/src/Support/EloquentModelObserver.php
...
This event will be called when exporting module

- Event name: modules.export_phrase

### Package Deleting Event

This event will be called when uninstalling module
