...
...
use MetaFox\Note\Http\Resources\v1\Note\SearchNoteForm;
use MetaFox\Note\Http\Resources\v1\Note\UpdateNoteForm;
use MetaFox\Note\Http\Resources\v1\Note\StoreNoteForm;
