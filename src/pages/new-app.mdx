...
We assume that you have set up development environment to build React on your machine/server. downloaded the _MetaFox_ source package and extract it on your local machine or server.
...
class WebSetting extends ResourceSetting
{
     ...
     */
    protected function initForms(): voidxx
    {
        $this->addForms([
...
Checking `backend/packages/note/config/drivers.php` contains
...
Let's open the `frontend/packages/note/src/pages/HomePage/Page.tsx` file and look into some annotations at the top of file
