...
Assume that you can install the MetaFox site with the the MetaFox Developer package on your local machine or server.
...
```php
    [
        'driver'     => 'MetaFox\\Company\\Http\\Resources\\v1\\Note\\WebSetting',
        'type'       => 'resource-web',
        'name'       => 'note',
        'version'    => 'v1',
        'resolution' => 'web',
