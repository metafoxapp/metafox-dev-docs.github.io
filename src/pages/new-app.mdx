...
npx metafox-cli create-app company/note

✔ What do you need? · Create new app
✔ What is vendor/company name? · company
...
Now we should add new routing from '/note' to `./src/pages/HomePage.tsx`

add new file `./src/pages/HomePage.tsx` and paste source.
