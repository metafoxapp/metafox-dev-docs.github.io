...
- Compress all subfolders within the `export` folder to zip format. On Linux or Mac machine, you can run following command in terminal: `cd export && zip export.zip -r .`
