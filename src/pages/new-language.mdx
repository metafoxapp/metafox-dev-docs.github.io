...
Now, you can update phrase values for _French_ language with any text editor tool. You can also refer to [Example Translation](/new-app/#translation) for more details.
